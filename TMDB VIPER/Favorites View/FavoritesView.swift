...
struct FavoritesView: View {
    ...
    var body: some View {
        ForEach(presenter.favoriteMovies) { movie in
            SearchCellView(posterUrlString: movie.posterURLString ?? "No URL", title: movie.title ?? "No title", releaseDate: movie.releaseDate ?? "No release date", ratingText: movie.ratingText ?? "No rating")
                .anyButton {
